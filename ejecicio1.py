# Crea una función que tome un número como entrada y devuelva "Fizz" si el número es divisible por 3,
...
#Crea una función que tome una lista de números como entrada 
